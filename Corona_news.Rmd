---
title: \textcolor{glaucous}{\Huge 新冠早报}
...
\lhead{\includegraphics[height=2cm]{./test/logo.png}}
\rhead{
\begin{tabular}{ccc}
...
\includegraphics[]{./test/covid2.png}
\caption{累计确诊病例国家趋势图}
\label{}
\end{minipage}
\quad
\begin{minipage}[b]{0.45\linewidth}
\includegraphics[]{./test/covid3.png}
...
\centering
\begin{minipage}[b]{0.45\linewidth}
\includegraphics[]{./test/covid5.png}
\caption{美国本土疫情分布图}
\label{}
\end{minipage}
\quad
\begin{minipage}[b]{0.45\linewidth}
\includegraphics[]{./test/covid6.png}
