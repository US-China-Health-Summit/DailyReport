...
**\textcolor{glaucous}{`r native_news$pub[1]`}**: **`r international_news$title[1]`**
...
\label{Fig.sub.1}
\includegraphics[width=0.45\textwidth]{./input/covid2.png}}
\subfigure[日新增确诊病例国家趋势图]{
\label{Fig.sub.2}
\includegraphics[width=0.45\textwidth]{./input/covid3.png}}
\caption{}
\label{Fig.main}
\end{figure}
...
\subfigure[美国本土疫情分布图]{
\label{Fig.sub.1}
\includegraphics[width=0.45\textwidth]{./input/covid5.png}}
\subfigure[美国累计确诊前五位州趋势图]{
\label{Fig.sub.2}
\includegraphics[width=0.45\textwidth]{./input/covid6.png}}
\caption{}
\label{Fig.main}
\end{figure}
