...
# plot 1. total confirmed cases sort by countries totala
...
#plot total deaths of top_n countries (sorted in current descending order)
...
Confirmed = read.csv("~/R/covid-19/upload/input_us_data_0322_Confirmed.csv", stringsAsFactor = F, header = F)
colnames(Confirmed) = Confirmed[1, ]
Confirmed = Confirmed[-1, ]
Deaths = read.csv("~/R/covid-19/upload/input_us_data_0322_Deaths.csv", stringsAsFactor = F, header = F)
colnames(Deaths) = Deaths[1, ]
Deaths = Deaths[-1, ]

state_population = read.csv("~/R/covid-19/upload/input_state_population.csv", stringsAsFactors=F)
