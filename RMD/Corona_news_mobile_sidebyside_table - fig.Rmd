...
\begin{center}
\fontsize{22}{22}
{\textcolor{glaucous}{\textbf{第68期 \space 6月24日}}}
\end{center}
...
\begin{Large}
{数据源：约翰霍普金斯大学，The COVID Tracking Project \\ 数据截止至：北京时间6月24日 上午8:00}
\end{Large}
...
\begin{figure}[H] 
\caption{世界上实施全民医疗卫生分布图，版权属于Pharexia} %最终文档中希望显示的图片标题
\centering
\includegraphics[]{./input/covid7.png} %插入图片，[]中设置图片大小，{}中是图片文件名
\label{} %用于文内引用的标签
\end{figure}
