...
```{r}
cn_name = read_csv("./translation/cn/world.csv")
en_name = read_csv("./translation/en/world.csv")
...
input_state_pop_translated = left_join(input_state_pop, state_cn, 
                                       by = "State_Full") %>% 
  select(State, State_Full, State_cn, Population) %>% 
  unite("State_bi", State_Full:State_cn, sep = " - ", remove = F)
```
